---
title: Adding Bolt to an Existing Project | bolt-framework
...
<Meta title="Getting Started/Adding Bolt to an Existing Project" />

# Adding Bolt to an Existing Project

## Table of Contents

- <a href="#adding-bolt-to-a-project">Adding Bolt to a project</a>

- <a href="#adding-a-project-service-as-bolt-service">Adding a Project Service as Bolt Service</a>

- <a href="#running-project-via-bolt">Running Project via Bolt</a>

- <a href="#listing-services-from-project">Listing Services From Project</a>

- <a href="#monitoring-service-logs">Monitoring Service Logs</a>

- <a href="#stopping-project-via-bolt">Stopping Project via bolt</a>
