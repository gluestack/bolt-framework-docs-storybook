...
- <a href="#adding-project-files">Adding project files</a>

- <a href="#creating-bolt-project">Creating Bolt Project</a>

- <a href="#adding-a-bolt-service">Adding a Bolt Service</a>

- <a href="#running-bolt-project">Running Bolt Project</a>

- <a href="#listing-bolt-services">Listing Bolt Services</a>

- <a href="#monitoring-service-logs">Monitoring Service Logs</a>

- <a href="#stopping-bolt-project">Stopping Bolt Project</a>
