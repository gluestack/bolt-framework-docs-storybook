---
title: Next Postgres PGAdmin BoltIngress Molecular | bolt-framework
...
<Meta title="Tutorials/Next Postgres PGAdmin BoltIngress Molecular" />

# Tutorial: Next Postgres PGAdmin BoltIngress Molecular

This tutorial is about how to run a Next.js Postgress PgAdmin and Molecular.js in a project using bolt on docker and we will also
setup Bolt Ingress with our microservices.

<AppProvider>
  <Box>
    <video controls width="80%">
      <source src="/assets/NextMolecularBolt.mp4" type="video/mp4" />
...
frontend-backend-pgadmin-postgres/
╰─➤ services/
  ╰─➤ backend
  ╰─➤ frontend
  ╰─➤ pgadmin
...
```bash
$ cd frontend-backend-pgadmin-postgres
$ bolt init
```
...
project_name: frontend-backend-pgadmin-postgres
services: null
ingress: null
```
