---
title: Nest Expo Postgres PgAdmin | bolt-framework
...
<Meta title="Tutorials/Nest Expo Postgres PgAdmin" />
...
<AppProvider>
  <Box>
    <video controls width="80%">
      <source src="/assets/NestExpoPostgres.mp4" type="video/mp4" />
...
╟───┼──────────────┼────────┼────────────────┼──────┼───────────╢
║ 1 │ postgres     │ down   │ NA             │ NA   │ NA        ║
╟───┼──────────────┼────────┼────────────────┼──────┼───────────╢
║ 2 │ pgadmin      │ down   │ NA             │ NA   │ NA        ║
╟───┼──────────────┼────────┼────────────────┼──────┼───────────╢
║ 3 │ todofe       │ down   │ NA             │ NA   │ NA        ║
╟───┼──────────────┼────────┼────────────────┼──────┼───────────╢
║ 4 │ todobackend  │ down   │ NA             │ NA   │ NA        ║
╚═══╧══════════════╧════════╧════════════════╧══════╧═══════════╝
```
...
To clone the project you can use [bolt-framework-tutorial-apps/examples/bolt-todo](https://github.com/gluestack/bolt-framework-tutorial-apps/tree/main/examples/bolt-todo)
