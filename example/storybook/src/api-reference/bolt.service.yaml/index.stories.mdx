...
1. If you use `local` as your default service runner, Bolt CLI will run your services on your host machine's local.
2. If you use `docker` as your default service runner, Bolt CLI will run your services on your host machine's Docker.
3. If you use `vmlocal` as your default service runner, Bolt CLI will run your services on your virtual machine's local.
4. If you use `vmdocker` as your default service runner, Bolt CLI will run your services on your virtual machine's Docker.
