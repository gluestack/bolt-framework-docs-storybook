...
const getStories = () => {
  return [
    ...
    require('../src/api/ColorModeBasedStyles/ColorMode.stories'),
    require('../src/api/Variants/BaseStyleVariantSizes.stories'),
    require('../src/api/AsForwarder/AsForwarder.stories'),
